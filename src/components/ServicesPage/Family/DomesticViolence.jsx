            ...
            >
              ...
              {spouseState && (
                ...
                >
                  ...
                  >
                    <List.Item>
                      <strong>Physical Abuse</strong>: Involves physical harm or
                      threats of violence.
                    </List.Item>
                    <List.Item>
                      <strong>Emotional Abuse</strong>: Includes verbal insults,
                      intimidation, and manipulation
                    </List.Item>
                    <List.Item>
                      <strong>Financial Abuse</strong>: Controlling or
                      restricting access to financial resources
                    </List.Item>
                    <List.Item>
                      <strong>Sexual Abuse</strong>: Any non-consensual sexual
                      activity
                    </List.Item>
                    <List.Item>
                      <strong>Mental Abuse</strong>: Psychological tactics to
              ...
              {applicationState && (
                ...
                >
                  ...
                  >
                    ...
                    controlling behaviour was criminalised in December 2015,
                    enabling the police to take protective action and prosecute
                    abusers.
                  </Text>
                </VStack>
              )}
            ...
            >
              ...
              {screening && (
                ...
                >
                  ...
                  >
                    <List.Item>
                      <strong>Immediate Danger</strong>: If you are in immediate
                      danger, call 999 and ask for the police
                    </List.Item>
                    <List.Item>
                      <strong>National Domestic Violence Helpline</strong>: For
                      support and advice, call 0808 2000 247 or visit{" "}
                      <Link
                        to={"http://www.nationaldahelpline.org.uk/"}
                    ...
                    <List.Item>
                      <strong>Legal Advice</strong>: Seeking legal advice from
                      solicitors specializing in domestic abuse can help build
                      your case and provide the necessary protection and support
                    </List.Item>
                  </List.Root>
              ...
              {decisionState && (
                ...
                >
                  ...
                  >
                    ...
                    with domestic violence matters effectively:
                  </Text>
                  ...
                  >
                    ...
                    provide you with clear advice on your rights and the legal
                  ...
                  <Text
                    ...
                    fontFamily={"CeraRoundPro"}
                  >
                    <strong>Injunctions and Protective Orders</strong>: Our
                    experienced solicitors assist in obtaining injunctions and
                    protective orders to ensure your safety and the safety of
                    your loved ones.
                  </Text>
                  ...
                  >
                    ...
                    legal assistance for emergency applications, such as
                    non-molestation orders and occupation orders, to provide
                  ...
                  >
                    ...
                    and advice to help you navigate the legal process and access
                    additional resources, such as counseling and support
                    services.
                  </Text>
                </VStack>
              )}
              ...
              {helpState && (
                ...
                >
                  <Text
                    ...
                    fontFamily={"CeraRoundPro"}
                  >
                    At Lumine, we understand the intricacies of domestic
                    violence cases and are dedicated to providing personalized
