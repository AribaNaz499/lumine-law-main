      ...
      >
        ...
        <Box width="100%" flex="1" p={0} m={0} pt={"50px"}>
          ...
          >
            ...
            >
              ...
              <Heading
                ...
                mt={6}
                mb={3}
                fontSize={{ xs: "14px", lg: "23px", xl: "29px", "2xl": "37px" }}
                textAlign={"left"}
                ml={3}
              >
          ...
          <VStack justifyContent={"space-around"} alignItems={"center"} mb={"50px"}>
            ...
            {/* Dropdown 1 - What is a Student visa? */}
              ...
              {allowState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  ...
                  <List.Root textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} mt={-10} ml={{lg:"-3", xs:"1"}} lineHeight={1.8} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
                    ...
                    <List.Item>Work during term time and full time during off-term time in the UK</List.Item>
                    <List.Item>Bring immediate family, while studying, to the UK</List.Item>
                  </List.Root>
                </VStack>
              )}
            </Box>

            {/* Dropdown 3 - Eligibility */}
            <Box display={"flex"} flexDir={"column"} color={"black"} width={"93%"} justifyContent={"center"} alignItems={"center"}>
              <HStack
                borderTop={"1px solid #adacac"}
                width={"100%"}
              ...
              {eligibilityState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <List.Root textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} ml={{lg:"-3", xs:"1"}} lineHeight={1.8} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
                    <List.Item>You must have confirmation of acceptance for studies (CAS) from a licensed sponsor</List.Item>
                    <List.Item>You must meet the English language requirements</List.Item>
                    <List.Item>You must be 16 and over (evidence of parental consent is required) – you can apply for the Child Student Visa if your 16-17 year-olds & want to attend a school in the UK</List.Item>
                    <List.Item>You must have been offered a place on a course by a licenced student sponsor.</List.Item>
                    <List.Item>You must meet financial requirements and have enough money to cover yourself and your living costs in the UK.</List.Item>
                  </List.Root>
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} ml={2} mb={4} mt={-6} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
            ...
            {/* Dropdown 4 - How long does it take to reach a decision? */}
            <Box display={"flex"} flexDir={"column"} color={"black"} width={"93%"} justifyContent={"center"} alignItems={"center"}>
              <HStack
                borderTop={"1px solid #adacac"}
                width={"100%"}
              ...
              {applyState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <List.Root textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} ml={{lg:"-2", xs:"1"}} mr={{xs:"1"}} lineHeight={1.8} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
                    <List.Item>
            ...
            {/* Dropdown 5 - How can Lumine Solicitors help? */}
            <Box display={"flex"} flexDir={"column"} color={"black"} width={"93%"} justifyContent={"center"} alignItems={"center"}>
              <HStack
                borderTop={"1px solid #adacac"}
                width={"100%"}
              ...
              {review && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  ...
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} ml={{lg:"3", xs:"1"}} mr={{lg:"4", xs:"1"}} mt={{lg:"-7", xs:"-4"}} fontWeight={400} lineHeight={1.9} fontFamily={"CeraRoundPro"} color={"gray.800"}>
