      ...
      >
        ...
        <Box width="100%" flex="1" p={0} m={0} pt={"50px"}>
          ...
          <VStack justifyContent={"space-around"} alignItems={"center"} mb={"50px"}>
            ...
            {/* Dropdown 1 - What is Switching Visas? */}
            <Box display={"flex"} flexDir={"column"} color={"black"} width={"93%"} justifyContent={"center"} alignItems={"center"}>
              ...
              {spouseState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} lineHeight={1.8} mb={2} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
            ...
            {/* Dropdown 2 - What Type of Visas Can You Switch? */}
            <Box display={"flex"} flexDir={"column"} color={"black"} width={"93%"} justifyContent={"center"} alignItems={"center"}>
              <HStack
                borderTop={"1px solid #adacac"}
                width={"100%"}
              ...
              {eligibilityState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
                  ...
                  <List.Root textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} mt={-5} lineHeight={1.8} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
                    <List.Item>Switching Into Work Visas e.g. innovator founder visa</List.Item>
                    <List.Item>Switching Into a Student Visa</List.Item>
                    <List.Item>Switching Into a Skilled Worker Visa</List.Item>
                    <List.Item>Switching into a Leave to Remain as A Family Member Of A British Citizen or Settled Person, e.g. spouse visa 5yr/10yr route</List.Item>
                  </List.Root>
                </VStack>
              )}
            </Box>
            ...
            <Box display={"flex"} flexDir={"column"} color={"black"} width={"93%"} justifyContent={"center"} alignItems={"center"}>
              ...
              {applicationState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  ...
                  <List.Root textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} mt={-5} lineHeight={1.8} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
                    <List.Item>You must be in the UK when you apply, and your current visa must not have expired</List.Item>
                    <List.Item>You must meet the immigration rules for the visa you are applying for</List.Item>
                    <List.Item>You must have adhered to the rules and conditions of stay of your visa</List.Item>
                    <List.Item>You must not have breached the law while in the UK</List.Item>
            ...
            <Box display={"flex"} flexDir={"column"} color={"black"} width={"93%"} justifyContent={"center"} alignItems={"center"}>
              ...
              {helpState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} mr={4} ml={3} lineHeight={1.9} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
                    At Lumine Solicitors we can:
                  </Text>
                  <List.Root textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "13px", lg: "13px", xl: "15px", "2xl": "17px" }} mt={-6} lineHeight={1.9} fontWeight={400} fontFamily={"CeraRoundPro"} color={"gray.800"}>
                    <List.Item>Confirm if your eligible to switch visas</List.Item>
                    <List.Item>Prepare and submit your visa switch application on your behalf</List.Item>
                    <List.Item>Handle any queries from the Home Office regarding your application</List.Item>
                    <List.Item>We can arrange your same-day service appointment with UK Visas and Immigration for the submission of your application at your convenience</List.Item>
                  </List.Root>
