...
const Banner = () => (
  <Box width="100%" height={{ base: "220px", xs: "260px", lg: "310px", xl: "360px", "2xl": "410px" }} position="relative" overflow="hidden">
    ...
    <Box position="relative" zIndex={2} display="flex" justifyContent="flex-start" alignItems="center" width="100%" height="100%">
      <Text fontSize={{ base: "24px", xs: "34px", sm: "38px", md: "42px", lg: "46px", xl: "48px" }} fontWeight={600} fontFamily="CeraRoundPro" ml={{ base: "5%", md: "5%" }} color="white" textShadow="2px 2px 4px rgba(0,0,0,0.5)">
...
const MainContent = () => (
  <Box width="100%" display="flex" flexFlow="column" color="black" px={{ base: "5%", md: "0" }}>
    ...
    <Box width={{ base: "100%", md: "95%" }} alignSelf="center" mb={{ base: "10%", xs: "15%", sm: "10%", md: "7.5%", xl: "5%" }}>
      <Text fontFamily="CeraRoundPro" fontWeight={400} ml={{ base: 0, md: 9 }} fontSize={{ base: "13px", md: "15px" }} textAlign="justify">
  ...
  <Box bg="white" width="100%" py={10} px={{ base: "5%", md: "8%" }} color="gray.700">
    <VStack align="flex-start" spacing={{ base: 6, md: 10 }} maxW="1300px" mx="auto">
      <Box textAlign={"left"} color={"#7a7a7a"}>
        <Heading as="h2" fontSize={{ base: "23px", md: "33px" }} fontWeight="600" mb={4} mt={{ base: 0, md: '-87px' }} >
      ...
      <Box textAlign={"left"} color={"#7a7a7a"}>
        <Heading as="h2" fontSize={{ base: "23px", md: "29px" }} mt={6} fontWeight="600" mb={3}>
          Trusted UK Immigration Solicitors in London
        </Heading>
        <Text fontSize={{ base: "13px", md: "15px" }} lineHeight="1.6" textAlign="justify">
      ...
      <Box w="100%" color={"#7a7a7a"}>
        <Heading as="h3" fontSize={{ base: "23px", md: "29px" }} textAlign={"left"} fontWeight="600" mb={4}>
      ...
      <Box color={"#7a7a7a"}>
        ...
        <Text textAlign={"left"} fontSize={{ base: "13px", md: "15px" }} mt={"4%"} mb={"22px"}>
        ...
        <VStack align="flex-start" spacing={3} lineHeight={"1.2"} ml={{ base: 2, md: 5 }} mt={7}>
        ...
        <Text ml={{ base: 2, md: "-40%" }} mt={8} fontSize="15px"><strong>• Full UK Coverage: </strong>While based in London, we work with clients throughout the UK and globally.</Text>
      </Box>

      <Box color={"#7a7a7a"}>
        <Heading as="h3" fontSize={{ base: "20px", md: "28px" }} mt={2} textAlign={"left"} fontWeight="600" mb={4}>
          Good Immigration Solicitors London Can Count On
        </Heading>
        <Text textAlign={"left"} fontSize={"15px"} mt={"4%"} >
      ...
      <Box color={"#7a7a7a"}>
        <Heading as="h3" fontSize={{ base: "20px", md: "28px" }} textAlign={"left"} fontWeight="600" mb={2} >
          Get in Touch Today
        </Heading>
        <Text textAlign={"left"} fontSize={"15px"} mb={"22px"}>
