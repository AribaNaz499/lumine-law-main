    ...
    <>
      ...
      >
        ...
        <Box width="100%" flex="1" p={0} m={0} pt={"50px"}>
          {/* Banner - HEADING FONT SIZE SAME, ONLY HEIGHT & BG CHANGE */}
          <Box
            width={"100%"}
            height={{
              base: "230px",
          ...
          >
            <Text
              fontSize={{ xs: "21px", lg: "38px", xl: "45px", "2xl": "53px" }}
              fontWeight={700}
          ...
          >
            ...
            >
              <Text
                ...
                color="black"
              >
                As the law is constantly subject to change, inheritance tax rules may mean that your loved ones might not profit from the distribution of your assets as you had intended if your estate exceeds a specific value. To ensure tax regulations are adhered to and that your loved ones are treated as you wish, our solicitors can create a tax-effective plan for you tailored to your needs.
              </Text>
            </Box>
          </Box>
              ...
              {decisionState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <Text
                    ...
                    color="gray.800"
                  >
                    If you have any further queries or are interested in our inheritance tax planning services, please do not hesitate to get in touch with Lumine solicitors{" "}
