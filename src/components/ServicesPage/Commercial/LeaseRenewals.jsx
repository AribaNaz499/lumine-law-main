          ...
          >
            ...
            >
              <Text
                ...
                color="black"
              >
                At Lumine Solicitors, we understand the importance of being proactive and noting key dates when it comes to commercial lease renewals. Neglecting these details can lead to losing the right to renew or oppose the lease. Additionally, we assist in avoiding issues such as unwanted tenants remaining in occupation or tenants facing the risk of losing their tenancy. Our team guides you through the renewal process with confidence and ease, ensuring your interests are protected every step of the way.
              </Text>
            </Box>
          </Box>
              ...
              {eligibilityState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <Text
                    ...
                    color="gray.800"
                  >
                    At Lumine Solicitors, we are dedicated to thoroughly understanding your business and its commercial goals. This enables us to provide tailored advice that aligns precisely with your objectives, ensuring a smooth process and a positive outcome for your lease renewal.
                  </Text>
                </VStack>
              )}
            </Box>
