...
const PropertyDilapidations = () => {
  ...
  return (
    <>
      ...
      >
        <Helmet>
          <title>Lumine Law Commercial Property Dilapidations Services</title>
        </Helmet>
        ...
        <Box width="100%" flex="1" p={0} m={0} pt={"50px"}>
          ...
          >
            <Text
              fontSize={{ xs: "18.5px", lg: "27.5px", xl: "33.5px", "2xl": "42.5px" }}
              fontWeight={600}
          ...
          >
            ...
            >
              <Text
                ...
                color="black"
              >
                Commercial property dilapidations refer to the legal obligations of tenants to maintain leased premises in good repair throughout the lease term and to return them in the required condition at lease end. It involves maintaining and repairing any disrepair or breaches of repair obligations under the lease.
              </Text>
            </Box>
          </Box>
              ...
              {eligibilityState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <Text
                    ...
                    color="gray.800"
                  >
                    We conduct comprehensive dilapidation assessments to clarify repair obligations and liabilities, ensuring transparency for both landlords and tenants. Our team prioritise efficient and effective dispute resolution, safeguarding your financial and legal interests.
                  </Text>
                </VStack>
              )}
            </Box>
...
export default PropertyDilapidations;