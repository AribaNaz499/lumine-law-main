          ...
          >
            ...
            >
              <Text
                ...
                color="black"
              >
                One essential service we offer involves creating and overseeing Schedules of Conditions.
              </Text>
              ...
              <Text
                ...
                mt={0}
              >
                A Schedule of Conditions is a detailed record documenting the condition of a property at a specific point in time. It includes assessments of structural elements, fixtures, and fittings. This document serves as a vital reference for parties involved in property transactions or lease agreements.
              </Text>
            </Box>
          </Box>
              ...
              {eligibilityState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <Text
                    ...
                    color="gray.800"
                  >
                    Our team specialises in creating and reviewing Schedules of Conditions that accurately detail your property. With our advice on what these schedules mean for property owners, tenants, and contractors, everyone understands their rights and responsibilities. If disagreements arise, we're here to resolve them effectively through strong representation and mediation services. Additionally, we assist property owners and managers in planning maintenance based on these schedules to preserve property value and reduce future risks.
                  </Text>
                </VStack>
              )}
            </Box>
