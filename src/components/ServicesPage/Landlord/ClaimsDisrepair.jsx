          ...
          >
            ...
            >
              <Text
                ...
                color="black"
              >
                Managing claims for disrepair involves various legal complexities that must be navigated carefully to ensure compliance and achieve a fair resolution. Lumine Solicitors is here to provide the expertise you can rely on and trust.
              </Text>
            </Box>
          </Box>
              ...
              {spouseState && (
                <VStack justifyContent={"center"} alignItems={"flex-start"} gap={{ xs: "20px", md: "30px" }} mb={{ xs: "4px", md: "10px" }} borderTop={"1px solid #adacac"} py={{ xs: "15px", md: "30px" }} width={"100%"}>
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "12.5px", lg: "12.5px", xl: "14.5px", "2xl": "16.5px" }} fontWeight={400} fontFamily={"CeraRoundPro"} lineHeight={1.7} color="gray.800">
                    At Lumine, we offer comprehensive services to assist you with claims for disrepair effectively:
                  </Text>
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "12.5px", lg: "12.5px", xl: "14.5px", "2xl": "16.5px" }} fontWeight={400} fontFamily={"CeraRoundPro"} mt={-7} lineHeight={1.7} color="gray.800">
                    <strong>Assessment and Documentation</strong>: Our experienced solicitors conduct thorough assessments of property conditions to document instances of disrepair. We gather evidence to support your claim and ensure compliance with legal standards.
                  </Text>
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "12.5px", lg: "12.5px", xl: "14.5px", "2xl": "16.5px" }} mt={-7} fontWeight={400} fontFamily={"CeraRoundPro"} lineHeight={1.7} color="gray.800">
                    <strong>Negotiation and Settlement</strong>: We employ negotiation techniques to resolve disrepair claims amicably. Our goal is to reach a fair settlement that addresses the issues and compensates for any inconvenience or loss.
                  </Text>
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "12.5px", lg: "12.5px", xl: "14.5px", "2xl": "16.5px" }} mt={-7} fontWeight={400} fontFamily={"CeraRoundPro"} lineHeight={1.7} color="gray.800">
                    <strong>Legal Proceedings</strong>: When negotiation fails, we initiate legal proceedings to resolve disrepair claims. We guide you through the court process, ensuring that all actions are legally compliant and strategically sound.
                  </Text>
                  <Text textAlign={"justify"} fontSize={{ xs: "11px", sm: "11px", md: "12.5px", lg: "12.5px", xl: "14.5px", "2xl": "16.5px" }} mt={-7} fontWeight={400} fontFamily={"CeraRoundPro"} lineHeight={1.7} color="gray.800">
                    <strong>Compliance and Remediation</strong>: We provide expert advice on compliance with relevant laws and regulations related to property conditions. Our team assists with the remediation of disrepair to ensure that properties meet legal standards and avoid future disputes.
                  </Text>
                </VStack>
              )}
            </Box>
