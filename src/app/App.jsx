...
// 🔹 AUTH IMPORTS - YEH ADD KIYA HAI (NAYA)
...
function App() {
  return (
    <>
      ...
      {/* IMPORTANT: AuthProvider ko BrowserRouter ke ANDAR aur Navbar ke UPAR rakho */}
      <BrowserRouter>
        <AuthProvider>   {/* <-- YEH ADD KIYA HAI */}
          <Navbar />
          ...
          <Suspense fallback={<LoadingSpinner />}>
            <Routes>
              ...
              {/* 🔹 News Routes - YAHAN PROTECTED ROUTE LAGAYA HAI */}
              ...
              {/* 🔹 PROTECTED ROUTE - Admin Editor (Sirf login ke baad) */}
              <Route 
                path="/admin/articles/new" 
                element={
                  <ProtectedRoute>
                    <SuspensePageTransition><ArticleEditor /></SuspensePageTransition>
                  </ProtectedRoute>
                } 
              />
